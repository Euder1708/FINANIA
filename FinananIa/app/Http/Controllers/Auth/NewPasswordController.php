...
class NewPasswordController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        // actualizaremos la contraseña en el modelo del usuario y la persistiremos en la
        // base de datos. De lo contrario, analizaremos el error y retornaremos la respuesta.
        ...
        // redirigirlo a donde estaba con su mensaje de error.
